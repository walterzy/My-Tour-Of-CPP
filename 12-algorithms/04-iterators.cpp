...
// Some containers return iterators that support only the above operations, while others return 
// iterators that can move forward and backward, be compared with <, and so on.
//
...
//
// This model of separation between data storage and algorithm delivers very general and flexible 
// software.
//
// Iterators and standard algorithms work equivalently on every standard container for which 
