...
public:
    ...
    complex(double real, double image) : real_{real}, image_{image} 
        {std::cout << "Constructor: complex(double real, double image)" << std::endl;}
    complex(const complex& c) : real_{c.real_}, image_{c.image_} 
        {std::cout << "Constructor: complex(const complex& c)" << std::endl;}
